...
import {getDraftMancerCard} from "../../../src/hells-cubes/draftmancer/getDraftMancerCard"
import {DraftmancerCard} from "../../../src/hells-cubes/types"
...
const getDraftmancerCube = () => {
  for (const set of [
    ...
    const filteredToSet = (data as { data: HCCard.Any[] }).data.filter((e) => {
      return e.set == set.id;
    });
