...
The reason the deck runs no copies of Prismatic Piper, instead of taking advantage of the free -2 deck size is that I am making a genius meta-play against the dominant mill meta deck. It is not because I did not know about and had never seen Piper before today.`,
  ...
  },
  {
    title: "millions",
    author: "sixel",
    text: "goal, get spell count banned",
    cards: {
      main: [
        { count: 3, name: "Half-Centaur of Kruphix" },
        // { count: 3, name: "Scapegoat (HC3)" },
        { count: 3, name: "Mana Pool Lifeguard" },
        { count: 4, name: "Caracas" },
        { count: 4, name: "Spell Count" },
        { count: 2, name: "LETS GO GAMBLING!!! // aw dang it" },
        { count: 2, name: "Pictures of Tamiyo's Feet" },
        { count: 3, name: "Undo Move" },
        { count: 3, name: "Flummox" },
        { count: 4, name: "Llanowar Lolly Licker" },
        { count: 3, name: "Omnathation" },
        // { count: 3, name: "Azuza, Lost and Found and Seeking" },
        { count: 1, name: "Island GX" },
        { count: 4, name: "Swamp (hc)" },
        { count: 4, name: "Ig // Noble Hierarch" },
        { count: 4, name: "Enlightening Axe" },
        { count: 4, name: "Underworld Beach" },
        { count: 4, name: "Shifting River // Shifting Forest" },
        // { count: 4, name: "Heaven's ent" },
        { count: 4, name: "Pondervale" },
        // { count: 4, name: "Bill and Tifa's Excellent Adventure" },
        { count: 4, name: "Earth // Wind // Fire" },
      ],
      sideboard: [
        { count: 3, name: "Grounter Spell" },
        { count: 3, name: "Swiss Army Knife" },
        { count: 3, name: "Was land" },
        { count: 3, name: "Time // Waste" },
        { count: 3, name: "Ancestral Greed" },
      ],
    },
  },
];
