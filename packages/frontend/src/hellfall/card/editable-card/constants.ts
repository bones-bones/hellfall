...
export const FACE_FIELD_CONFIGS: FieldConfig[] = [
  ...
  { key: 'supertypes', label: 'Supertypes', type: 'semicolon-list' },
  { key: 'types', label: 'Types', type: 'semicolon-list' },
  { key: 'subtypes', label: 'Subtypes', type: 'semicolon-list' },
  ...
  { key: 'drop_face', label: 'Drop Face', type: 'boolean' },
  { key: 'attraction_lights', label: 'Attraction Lights', type: 'string' },
];
