...
export const StyledLabel = createStyledLabel(labelStyles, 'StyledLabel');

const legendStyles = createStyles({ fontWeight: 'bold' });
export const StyledLegend = createStyledLegend(legendStyles, 'StyledLegend');
...
export const StyledComponentHolder = createStyledDiv(
  componentHolderStyles,
