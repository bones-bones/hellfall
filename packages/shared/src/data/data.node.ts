...
export const artistsDataAsync = Promise.resolve(loadJsonFileSync<string>('artists.json'));
export const keywordsDataAsync = Promise.resolve(loadJsonFileSync<string>('keywords.json'));
...
export const artistsData = loadJsonFileSync<string>('artists.json');
export const keywordsData = loadJsonFileSync<string>('keywords.json');
