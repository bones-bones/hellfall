export type { JsonDataWrapper } from './jsonDataWrapper';
export { loadCardsData } from './cards.browser.ts';
export { tagsData } from './tags.browser.ts';
export { landsData } from './lands.browser.ts';
