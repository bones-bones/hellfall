...
// can delete
// Image URLs live in the DB (Drive lh3 and/or GCS). The sheet often leaves those
// columns blank, so they must not be sheet-removable or empty cells wipe existing URLs.
